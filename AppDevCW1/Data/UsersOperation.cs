...
public static class UsersOperation
{
    ...
    private static void SaveAll(List<User> users)
    {
        ...
        string appUsersFilePath = Func.GetAppUsersFilePath();
    ...
    public static List<User> Create(Guid userId, string username, string password, Role role)
    {
        ...
        users.Add(
            ...
            {
                Username = username,
                PasswordHash = Func.HashSecret(password),
                Role = role,
                CreatedBy = userId
            }
        );
    ...
    public static User Login(string username, string password)
    {
        ...
        bool passwordIsValid = Func.VerifyHash(password, user.PasswordHash);
    ...
    public static User ChangePassword(Guid id, string currentPassword, string newPassword)
    {
        ...
        bool passwordIsValid = Func.VerifyHash(currentPassword, user.PasswordHash);
        ...
        user.PasswordHash = Func.HashSecret(newPassword);
